...
public class CustomepzbwMustSpinner extends Spinner implements OnItemClickListener {

	public static SelectDialog dialog = null;
	private ArrayList<SpinnerItem> list;
	public static String text;

	public CustomepzbwMustSpinner(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
	@Override
