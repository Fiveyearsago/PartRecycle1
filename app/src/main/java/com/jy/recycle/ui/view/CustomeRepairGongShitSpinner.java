...
public class CustomeRepairGongShitSpinner extends Spinner implements OnItemClickListener {

	public static SelectDialog dialog = null;
	private ArrayList<SpinnerItem> list;
	public static String text;

	public CustomeRepairGongShitSpinner(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
	@Override
