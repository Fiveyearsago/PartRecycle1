...
public class CustomeRepairPriceMustSpinner extends Spinner implements OnItemClickListener {

	public static SelectDialog dialog = null;
	private ArrayList<SpinnerItem> list;
	public static String text;

	public CustomeRepairPriceMustSpinner(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
	@Override
	public boolean performClick() {
		...
		textTitle.setText("工时方案");
		ListviewMustAdapter adapters = new ListviewMustAdapter(context, getList());
