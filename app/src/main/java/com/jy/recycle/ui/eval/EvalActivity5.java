 ...
 */
public class EvalActivity5 extends JyBaseActivity implements DialogUtil.DialogCallBack {
    ...
    private VersionInfoReq versionInfoReq;// 更新请求
    private VersionInfoRsp versionInfoRsp;// 更新相应
    ...
    private ActingBrandItemDao actingBrandItemDao = new ActingBrandItemDao();
    ...
    // private Button btnPictureSelectionMode;
    ...
    private TextView textPartPlan;
    private EditText ed;
    private Dialog inputDialog;
    private String inputNum, inputMark;
    private TextView tvVehCheXingName;
    private TextView managerRateTxt;
    private TextView lossReamantTxt;
    ...
    private EditText personTelTxt;
    private EditText addressTxt;
    private EditText saoMiaoTextView;
    private final static int SCANNIN_GREQUEST_CODE = 1;
    private final static int SCANNIN_PHOTO_CODE = 2;
    private List<QuestionAnswerDetial> partPhotoList;
    ...
    private EditText reginstNo;
    private EditText carNo;
    private EditText person;
    private EditText personTel;
    private EditText personAdd;
    private TextView batchAdd;
    private EditText reginstNo4;
    ...
    private String sfid = "";// 省份ID
    private String csid = "";// 城市ID
    ...
    private Bundle mBbundle = new Bundle();
    private String remId = "";// 回收单ID
    private ArrayList<EvalPartInfo> evalPartList = new ArrayList<EvalPartInfo>();
    private Button mbtnDelAll;
    private EvalPartAdapter partAdp;
    private String sfcp = "";// 省份车牌
    private QuestionDetailAction action;
    private String secondFlag = "";// 对接标识
    private String ljmc = "";
    private String turnFlag = "0";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.eval_main5);
        context = this;
...
//                    });
            ...
            case TIHUO_REQUEST_CODE:
                ...
                if (resultCode == RESULT_OK) {
                    if (data != null) {
                        Bundle bundle = data.getExtras();
                        // Log.i("TIHUO_REQUEST_CODE", TIHUO_REQUEST_CODE + "");
                        vipRoleDate = bundle.getString("time");
                        startTime=bundle.getString("startTime");
                        // Log.i("time", vipRoleDate);
                        tihuoInfos = (List<TihuoInfo>) bundle
                                .getSerializable("tihuoList");
                        // List<TihuoInfo> tList = (List<TihuoInfo>) bundle
                        // .getSerializable("tihuoList");
                        tInfos = new ArrayList<TihuoInfo>();
                        tihuoString = "";
    ...
    private void getCityInfo() {
        new AsyncTask<Void, Void, JSONObject>() {
            ...
            protected void onPreExecute() {
                progressDialog = ProgressDialog.show(EvalActivity5.this,
                        "请稍候", "正在加载中...");
            }

            @Override
            protected JSONObject doInBackground(Void... params) {
                JSONObject response = ServerApiManager.getCity(share.data()
                        .getUserName(), "");
    ...
    public List<ProvinceInfo> analysisJson(String json) {
        try {
            ...
            for (int i = 0; i < array.length(); i++) {
                ...
                List<CityInfo> cInfos = new ArrayList<CityInfo>();
            ...
            List<CityInfo> ciInfos = new ArrayList<CityInfo>();
    ...
    private void findViews() {
        ...
        this.reginstNo4 = (EditText) findViewById(R.id.loss_no4);
        ...
        reginstNo4.addTextChangedListener(textReport4);
        ...
        this.personAdd.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    Intent intent = new Intent(EvalActivity5.this, SelectAddressActivity.class);
        ...
        provinceInfos = new ArrayList<ProvinceInfo>();
        ...
        this.personTxt = (EditText) findViewById(R.id.text_contentPerson);
        ...
        contentPersonTxt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EvalActivity5.this.startActivityForResult(intent, 3);
            }
        });
        ...
        batchAdd = (TextView) findViewById(R.id.eval_btn_outLine);
        batchAdd.setText("上传");
            ...
            public void onClick(View v) {
                ...
                if (checkPics()) {
                    ...
                    if (mState.equals("1003")
                        ...
                        Intent i = new Intent(EvalActivity5.this,
                        ...
                        if (tInfos != null && tInfos.size() == 0) {
                            DialogUtil.showDialog(context, "是否上传数据，数据将为暂存状态!", PublicStrings.REQUEST_CODE_UPLOAD_COMMIT, EvalActivity5.this);
                        } else {
                            Intent i = new Intent(EvalActivity5.this,
                                    UploadPicActivity.class);
                            i.putExtra("evalId", evalId);
    ...
    public final void logFileUpload() {
        new Thread() {
            @Override
            public void run() {
                try {
                    ...
                    String filePath = Constants.RES_LOG + "/" + strDate
                            + ".log";
                    ...
                    if (logFile.isFile() && logFile.exists()
                        ...
                        try {
                            ...
                            HttpConnectionParams.setConnectionTimeout(
                                    httpParameters, 30000);
                            HttpConnectionParams.setSoTimeout(httpParameters,
                                    30000);
                            httpClient = new DefaultHttpClient(httpParameters);
                            HttpContext localContext = new BasicHttpContext();
                            HttpPost httpPost = new HttpPost(share.getEvalUrl()
                                    + "/QtTaskUpload");
                            httpPost.addHeader("EstimateNoLossNo", SharedData
                                    .data().getEstimateNo()
                                    + SharedData.data().getEstimateNo());
    ...
    private void fillData() {
        ...
        if (evalLossInfo != null) {
            ...
            if (evalLossInfo.getReportThree() != null
                    && !"".equals(evalLossInfo.getReportThree())) {
                this.reginstNo3.setText(evalLossInfo.getReportThree());
            } else {
                evalLossInfoDao.updateregist3(evalId, reginstNo3.getText()
                        .toString());
            }
            this.reginstNo4.setText(evalLossInfo.getReportFour());
            ...
            // this.factoryName.setText(evalLossInfo.getRepairManagement());
            // this.companyName.setText(evalLossInfo.getCompanyType());
            // this.actingBand.setText(evalLossInfo.getActingBrand());
            // this.tvVehCertainName.setText(evalLossInfo.getVehGroupName());
            if (mState.equals("1003")) {
    ...
    private void bindViews() {
		/*
		 * EvalLossInfo eInfo =
		 * evalLossInfoAction.getEvalLossInfoByEvalId(evalId);
		 * share.saveReportNo(reportNo); String report = eInfo.getReportOne() +
		 * eInfo.getReportTwo() + eInfo.getReportThree();
		 * evalLossInfo.setPlateNo("C" + report);
		 * 
		 * String car = eInfo.getCarText() + eInfo.getCarNo();
		 * evalLossInfo.setCarNo(car);
		 */
    ...
    private void partDialog(EvalPartInfo eInfo) {
        ...
        View layout;
        if (mState.equals("1003") && evalPart.getEditFlag() != null
                && evalPart.getEditFlag().equals("0")) {
            layout = LayoutInflater.from(context).inflate(
                    R.layout.dag_editpart5_disable, null);
        } else {
            layout = LayoutInflater.from(context).inflate(
                    R.layout.dag_editpart5, null);
            ...
            selectButton.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    // TODO 相册选取照片
                    // ***改成应用的包名
                    Log.i("CHOSE_PHOTOS", "CHOSE_PHOTOS");
        ...
        if (mState.equals("1003") && evalPart.getEditFlag().equals("0")) {
        ...
        saoMiaoTextView = (EditText) layout.findViewById(R.id.result);
        ...
        mButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(EvalActivity5.this, ZBarCaptureActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivityForResult(intent, SCANNIN_GREQUEST_CODE);
            }
        });
        partPhotoList = detailAction.getQuestionDataFromM_VINNO_PHONE(String
                .valueOf(evalId));
        ...
        dialogOk.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!"".equals(saomiaoText)
                        && evalPartAction.getExistsErWeiMa(evalId,
                        evalPart.getPartId(), saomiaoText)) {
                    final AlertDialog alertDialog = new AlertDialog.Builder(
                            EvalActivity5.this).create();
                    alertDialog.show();
                    LayoutInflater inflater = (LayoutInflater) context
                            .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
                    View view = inflater.inflate(R.layout.dialog_tishi_one, null, false);
                    ...
                    tv_message.setText("已扫描过此零件，不能进行二次扫描!");
                    ...
                    tv_pos.setOnClickListener(new OnClickListener() {
                        ...
                        public void onClick(View v) {
                            // TODO Auto-generated method stub
                            alertDialog.dismiss();
                            saoMiaoTextView.setFocusable(true);
                        }
                    });
                    return;
                }
        ...
        dialogDel.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // new
                // EvalLossInfoAction(context).updateEvalLossSumInfo(evalId);
                fillData();
            }
        });
     ...
     * @param errorMessage
     */
    private void exitLioneyeWithNoDataReturn(String ressponseCode,
                                             String errorMessage) {
        EvalResponse response = new EvalResponse();
        response.setUserCode("jy");
        response.setPassword("jy");
        response.setResponseCode(ressponseCode);
     ...
     * @param response
     */
    private void setResult(EvalResponse response) {
        Intent mIntent = new Intent();
        GsonBuilder builder = new GsonBuilder();
        builder.setFieldNamingPolicy(FieldNamingPolicy.UPPER_CAMEL_CASE);
        Gson gson = builder.create();
        String claimEvalData = gson.toJson(response);
        LogUtil.saveFinish(share.getEstimateNo(), claimEvalData);
        mIntent.putExtra("CLAIMEVAL_DATA", claimEvalData);
        setResult(1, mIntent);
    }
    ...
    private void showImageDialog(Bitmap bitamp, final String path,
        ...
        builder.setView(view)
                ...
                .setNegativeButton("删除", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        // TODO Auto-generated method stub
                        EvalPartInfo evalPartInfo = evalPartAction
                                .getEvalPartById(partId);
                        if (mState.equals("1003")
                                && evalPartInfo.getEditFlag().equals("0")) {
    ...
    private String commitContent() {
        ...
        try {
            ...
            jsonObject1.put("bah", eInfo.getReportOne() + eInfo.getReportTwo()
                    + eInfo.getReportThree() + eInfo.getReportFour());
            ...
            if (dateFlag) {
                ...
                jsonObject1.put("vipRoleDate", currentDate == "null" ? ""
                        : currentDate);
            } else {
                jsonObject1.put("vipRoleDate", vipRoleDate == "null" ? ""
                        : vipRoleDate);
            }
    ...
    class EvalPartAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView,
            ...
            if (epart.getHuishouFlag() != null
                    && epart.getHuishouFlag().equals("1")) {
    ...
    TextWatcher textReport4 = new TextWatcher() {
        private CharSequence temp;
        ...
        public void afterTextChanged(Editable s) {
            ...
            evalLossInfoDao.updateregist4(evalId, s.toString());
            evalLossInfo.setReportThree(reginstNo4.getText().toString());
        }
    };
    ...
    private boolean checkPics() {
        ...
        if (reginstNo2.getText().length() < 2) {
            Toast.makeText(getApplicationContext(), "报案号长度是2位", Toast.LENGTH_SHORT).show();
            reginstNo2.requestFocus();
            Selection.setSelection((Spannable) reginstNo2.getText(), reginstNo2
                    .getText().length());
            return false;
        }
        if (reginstNo3.getText().length() < 2) {
            Toast.makeText(getApplicationContext(), "报案号长度是2位", Toast.LENGTH_SHORT).show();
        ...
        if (reginstNo4.getText().length() < 6) {
            Toast.makeText(getApplicationContext(), "报案号长度是6位", Toast.LENGTH_SHORT).show();
            reginstNo4.requestFocus();
            Selection.setSelection((Spannable) reginstNo4.getText(), reginstNo4
                    .getText().length());
            return false;
        }
    ...
    private void delOnePart(final String remId, final String goodListId) {
        new AsyncTask<Void, Void, JSONObject>() {
            @Override
            protected void onPreExecute() {
                // progressDialog = ProgressDialog.show(EvalActivity3.this,
                // "请稍候。。。", "正在删除中。。");
            }
...
//        radioRepairYes.setEnabled(false);
        ...
        mbtnDelAll.setVisibility(View.GONE);
        reginstNo4.setTextColor(Color.BLACK);
    ...
    private void bindHsdData() {
        ...
        if (!mHsdInfo.getBah().equals("null") && !mHsdInfo.getBah().equals("")) {
            try {
                eInfo.setReportOne(mHsdInfo.getBah().substring(0, 2));
                eInfo.setReportTwo(mHsdInfo.getBah().substring(2, 4));
                eInfo.setReportThree(mHsdInfo.getBah().substring(4, 6));
                eInfo.setReportFour(mHsdInfo.getBah().substring(6, 12));
            } catch (Exception e) {
                // TODO: handle exception
                e.printStackTrace();
            }
        ...
        for (int i = 0; i < pjInfos.size(); i++) {
            ...
            hsdEInfo.setEditFlag(pjInfos.get(i).getEditFlag());
