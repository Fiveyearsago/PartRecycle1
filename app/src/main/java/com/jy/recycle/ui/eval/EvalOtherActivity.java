 ...
 */
public class EvalOtherActivity extends JyBaseActivity implements DialogUtil.DialogCallBack {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.eval_main_other);
        context = this;
        ...
        initLocation();
        EvalApplication.getInstance().addActivity(EvalOtherActivity.this);
        initBaseData();
    ...
    private HSDInfo analysisHSDJson(String jsonString) {
        // TODO 下载回收单数据
...
//                    csmc, vipRoleDate, vehSeriId, vehCertainId, pjInfos,
//                    tihuoInfos);
            mHsdInfo = hsdInfo;
            // Log.i("HSDInfo", hsdInfo.toString());
        } catch (JSONException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
...
//                    });
    ...
    private void getCityInfo() {
        new AsyncTask<Void, Void, JSONObject>() {
            ...
            protected void onPreExecute() {
                progressDialog = ProgressDialog.show(EvalOtherActivity.this,
                        "请稍候", "正在加载中...");
            }
    ...
    private void findViews() {
        ...
        this.personAdd.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    Intent intent = new Intent(EvalOtherActivity.this, SelectAddressActivity.class);
        ...
        contentPersonTxt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EvalOtherActivity.this.startActivityForResult(intent, 3);
            }
        });
            ...
            public void onClick(View v) {
                ...
                if (checkPics()) {
                    ...
                    if (mState.equals("1003")
                        ...
                        if (flag) {
                            DialogUtil.showPosDialog(context, "未对数据进行修改，无需上传!", PublicStrings.REQUEST_CODE_UPLOAD_NO_COMMIT, EvalOtherActivity.this);
                        }

                    } else {
                        // Log.i("tInfos.size()", tInfos.size() + "");
                        if (tInfos != null && tInfos.size() == 0) {
                            DialogUtil.showDialog(context, "是否上传数据，数据将为暂存状态!", PublicStrings.REQUEST_CODE_UPLOAD_COMMIT, EvalOtherActivity.this);

                        } else {
                            Intent i = new Intent(EvalOtherActivity.this,
    ...
    private void partDialog(EvalPartInfo eInfo) {
        ...
        mButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(EvalOtherActivity.this,
                        ZBarCaptureActivity.class);
        ...
        dialogOk.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String ljbz = "";
                // if (diaLjbz.getTag() != null) {
                // ljbz = diaLjbz.getTag().toString();
                // } else {
                // ljbz = evalPart.getRemark();
                // }
                ...
                // partInfo.setLossPrice(price);
                // partInfo.setLossCount(num);
    ...
    private String commitContent() {
        ...
        String report = eInfo.getReportOne();
        ...
        try {
            ...
            jsonObject1.put("vin", "");
            jsonObject1.put("bah",
                    eInfo.getReportOne() == null ? "" : eInfo.getReportOne());
    ...
    class EvalPartAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView,
            ...
            Log.i("listphotopath", evalId + "   " + epart.getPartId());
    ...
    private boolean checkPics() {
        ...
        if (report == null || report.equals("")) {
            Toast.makeText(getApplicationContext(), "报案号不能为空!", Toast.LENGTH_SHORT).show();
            return false;
        }
        // 不判断报案号长度
        if (reginstNo1.getText().length() < 0) {
...
//        radioRepairYes.setEnabled(false);
    ...
    private void bindHsdData() {
        ...
        if (!mHsdInfo.getBah().equals("null") && !mHsdInfo.getBah().equals("")) {
            try {
                eInfo.setReportOne(mHsdInfo.getBah().substring(0,
                        mHsdInfo.getBah().length()));
            } catch (Exception e) {
                // TODO: handle exception
                e.printStackTrace();
            }
