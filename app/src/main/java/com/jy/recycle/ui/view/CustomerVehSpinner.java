...
public class CustomerVehSpinner extends Spinner implements OnItemClickListener {

	public static SelectDialog dialog = null;
	private ArrayList<SpinnerItem> list;
	public static String text;

	public CustomerVehSpinner(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
	@Override
