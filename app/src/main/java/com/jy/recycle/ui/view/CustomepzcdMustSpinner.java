...
public class CustomepzcdMustSpinner extends Spinner implements OnItemClickListener {

	public static SelectDialog dialog = null;
	private ArrayList<SpinnerItem> list;
	public static String text;

	public CustomepzcdMustSpinner(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
	@Override
