 ...
 */
public class EvalActivity6 extends JyBaseActivity implements DialogUtil.DialogCallBack {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.eval_main6);
        context = this;
        ...
        initLocation();
        EvalApplication.getInstance().addActivity(EvalActivity6.this);
        initBaseData();
...
//                    });
            ...
            case REQUEST_PICK_PHOTO:
                if (resultCode == RESULT_OK) {
                    ...
                    for (int i = 0; i < images.size(); i++) {
                        String picName = (TimestampTool.getStrDateTime() + String
                                .valueOf(i)).concat("_").concat(partId)
                                .concat(".jpg");
    ...
    private void getCityInfo() {
        new AsyncTask<Void, Void, JSONObject>() {
            ...
            protected void onPreExecute() {
                progressDialog = ProgressDialog.show(EvalActivity6.this,
                        "请稍候", "正在加载中...");
            }
    ...
    private void findViews() {
        ...
        this.personAdd.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    Intent intent = new Intent(EvalActivity6.this, SelectAddressActivity.class);
        ...
        contentPersonTxt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EvalActivity6.this.startActivityForResult(intent, 3);
            }
        });
            ...
            public void onClick(View v) {
                ...
                if (checkPics()) {
                    ...
                    if (mState.equals("1003")
                        ...
                        if (flag) {
                            DialogUtil.showPosDialog(context, "未对数据进行修改，无需上传!", PublicStrings.REQUEST_CODE_UPLOAD_NO_COMMIT, EvalActivity6.this);
                        }
                    } else {
                        // Log.i("tInfos.size()", tInfos.size() + "");
                        if (tInfos != null && tInfos.size() == 0) {
                            DialogUtil.showDialog(context, "是否上传数据，数据将为暂存状态!", PublicStrings.REQUEST_CODE_UPLOAD_COMMIT, EvalActivity6.this);

                        } else {
                            Intent i = new Intent(EvalActivity6.this,
    ...
    private void partDialog(EvalPartInfo eInfo) {
        ...
        mButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(EvalActivity6.this, ZBarCaptureActivity.class);
        ...
        dialogOk.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!"".equals(saomiaoText)
                    ...
                    DialogUtil.showPosDialog(context, "已扫描过此零件，不能进行二次扫描!", PublicStrings.REQUEST_CODE_QRCODE_REPEAT, EvalActivity6.this);
    ...
    private String commitContent() {
        ...
        evalLossInfo.setPlateNo(report);
        ...
        try {
            ...
            jsonObject1.put("bah", eInfo.getReportOne() + eInfo.getReportTwo() + eInfo.getReportThree() + eInfo.getReportFour());
            ...
            partDel.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    final AlertDialog alertDialog = new AlertDialog.Builder(
                            EvalActivity6.this).create();
                    alertDialog.show();
                    LayoutInflater inflater = (LayoutInflater) context
                            .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
                    View view = inflater.inflate(R.layout.dialog_tishi, null,
                            false);
    ...
    TextWatcher textReport4 = new TextWatcher() {
        ...
        public void afterTextChanged(Editable s) {
            ...
            evalLossInfo.setReportFour(reginstNo4.getText().toString());
    ...
    private boolean checkPics() {
        ...
        if (reginstNo3.getText().length() < 8) {
            Toast.makeText(getApplicationContext(), "报案号长度是8位", Toast.LENGTH_SHORT).show();
    ...
    private void bindHsdData() {
        ...
        if (!mHsdInfo.getBah().equals("null") && !mHsdInfo.getBah().equals("")) {
            try {
                ...
                eInfo.setReportThree(mHsdInfo.getBah().substring(5, 13));
                eInfo.setReportFour(mHsdInfo.getBah().substring(13, 19));
            } catch (Exception e) {
                // TODO: handle exception
                e.printStackTrace();
            }
