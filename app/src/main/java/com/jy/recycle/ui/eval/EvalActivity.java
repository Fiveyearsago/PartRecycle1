...
import com.jy.recycle.util.PermissionUtil;
 ...
 */
public class EvalActivity extends JyBaseActivity implements DialogUtil.DialogCallBack {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.eval_main);
        context = this;
        //获取权限
        PermissionUtil.getReadStatePermission(context);
        action = new QuestionDetailAction(context);
        pjInfos = new ArrayList<>();
        tihuohsd = new ArrayList<>();
        GetLocation.getLoc(EvalActivity.this, new GetLocation.LocationCallBack() {
            @Override
        ...
        EvalApplication.getInstance().addActivity(EvalActivity.this);
        initBaseData();
...
//                        }
                        Log.i("baos.toByteArray()", content.length + "");
                        String turnFlag = "0";
                        ImageUtils.compressBitmap1(content, ljmc, address1,
                                picPath, imgType, turnFlag, cString);
                        QuestionAnswerDetial details = new QuestionAnswerDetial();
                        details.setEval_id(String.valueOf(evalId));
                        details.setQuestion_id(partId);
                        details.setPic_name(ljmc);
...
//        this.personAdd.setOnClickListener(this);
        ...
        contentPersonTxt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EvalActivity.this.startActivityForResult(intent, 3);
            }
        });
            ...
            public void onClick(View v) {
                ...
                if (checkPics()) {
                    ...
                    if (mState.equals("1003")
                        ...
                        if (flag) {
                            DialogUtil.showPosDialog(context, "未对数据进行修改，无需上传!", PublicStrings.REQUEST_CODE_UPLOAD_NO_COMMIT, EvalActivity.this);
                        }

                    } else {
                        if (tInfos != null && tInfos.size() == 0) {
                            DialogUtil.showDialog(context, "是否上传数据，数据将为暂存状态!", PublicStrings.REQUEST_CODE_UPLOAD_COMMIT, EvalActivity.this);
                        } else {
                            Intent i = new Intent(EvalActivity.this,
    ...
    private void showNotSelectVehicleDialog() {
        // 给出提示并进入车型定型页面
        AlertDialog.Builder builder = new AlertDialog.Builder(context);
        builder.setTitle("提示").setMessage("请先进行车辆定型,然后再进行零件点选!")
                .setCancelable(false)
...
//                    intent.setClass(EvalActivity.this, MipcaActivityCapture.class);
        ...
        photoButton.setOnClickListener(new OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent i = new Intent(EvalActivity.this, PhotoPicActivity.class);
        ...
        dialogOk.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                Log.i("guanZhu",
                        guanZhu.getWidth() + "   " + guanZhu.getHeight());
                dialog.dismiss();
                // TODO Auto-generated method stub
    ...
    private String commitContent() {
        ...
        try {
            ...
            jsonObject1.put(
                    ...
                    "C" + eInfo.getReportOne() + eInfo.getReportTwo() + eInfo.getReportThree());
            jsonObject1.put("cph", UnicodeConverter.toEncodedUnicode(
                    eInfo.getCarText() + eInfo.getCarNo(), true));
            ...
            if (partList != null && partList.size() > 0) {
                int j = 0;
                //第一条传入null
//                JSONObject jbnull = null;
//                jsonArray.put(j, jbnull);
//                j = 1;
        ...
        public View getView(final int position, View convertView,
            ...
            partDel.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    tv_message.setText("“" + epart.getPartStandard() + "”吗？");
    ...
    private boolean checkPics() {
        ...
        if (report.equals("")) {
            Toast.makeText(getApplicationContext(), "报案号不能为空,且报案号必须是18位", Toast.LENGTH_SHORT)
                    .show();
            return false;
        }
        if (reginstNo1.getText().length() < 6) {
        ...
        if (reginstNo3.getText().length() < 5) {
            Toast.makeText(getApplicationContext(), "报案号长度是5位", Toast.LENGTH_SHORT).show();
...
//        radioRepairYes.setEnabled(false);
    ...
    private void bindHsdData() {
        ...
        if (!mHsdInfo.getBah().equals("null") && !mHsdInfo.getBah().equals("")) {
            try {
                eInfo.setReportOne(mHsdInfo.getBah().substring(1, 7));
                eInfo.setReportTwo(mHsdInfo.getBah().substring(7, 13));
