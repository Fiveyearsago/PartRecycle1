...
public abstract class SDSQLiteOpenHelper {
	...
	public File getDatabasePath(String name) {
		...
		{
			EXTERN_PATH = Environment.getExternalStorageDirectory().getAbsolutePath()+"/"+mContext.getString(R.string.dir)+
...
//		File f=new File(EXTERN_PATH+"/"+name);
//		Log.e("TTTTTTT",f.getPath());
